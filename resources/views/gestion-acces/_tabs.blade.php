{{-- Navigation des sous-modules « Gestion des accès » --}}
@php
    $tabs = [
        ['route' => 'users.index', 'label' => 'Utilisateurs', 'active' => ['users.*'], 'perm' => 'users.view'],
        ['route' => 'roles.index', 'label' => 'Rôles & droits', 'active' => ['roles.*'], 'perm' => 'users.view'],
        ['route' => 'audit.index', 'label' => 'Journal d\'audit', 'active' => ['audit.*'], 'perm' => 'audit.view'],
    ];
@endphp

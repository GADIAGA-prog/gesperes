    ...
    <nav class="px-3 py-4 space-y-1 overflow-y-auto h-[calc(100vh-4rem)]">
        @php
            $nav = [
                ...
                ['route' => 'suivi-dossiers.index', 'label' => 'Suivi des dossiers', 'perm' => 'suivi.view', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01', 'match' => 'suivi-dossiers.*'],
                ...
                ['route' => 'gpec.index', 'label' => 'Outils GRH', 'perm' => 'gpec.view', 'icon' => 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6', 'match' => ['gpec.*', 'outils-grh.*', 'plan-formation.*', 'besoins-formation.*', 'actions-formation.*']],

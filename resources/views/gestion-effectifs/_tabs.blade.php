{{-- Navigation du module « Gestion des effectifs » --}}
@php
    $tabs = [
        ['route' => 'agents.index', 'label' => 'Agents', 'active' => ['agents.*'], 'perm' => 'agents.view'],
        ['route' => 'structures.index', 'label' => 'Structures', 'active' => ['structures.*'], 'perm' => 'structures.view'],
    ];
@endphp
